...
function initChests(){
  ...
  chest1Div.setAttribute('class', '1');          //set elementclass, to compare with randomChestNr later
  chest2Div.setAttribute('id', 'chest2Div');
  chest2Div.setAttribute('class', '2');          //set elementclass, to compare with randomChestNr later
  chest3Div.setAttribute('id', 'chest3Div');
  chest3Div.setAttribute('class', '3');          //set elementclass, to compare with randomChestNr later
...
function getImageFromPexels(){
  ...
  xhr.onload = function(){
    if(this.status == 200){
      ...
      randomizeImage();               //get new random image
    }
  }
  xhr.send();
}
...
//   randomChestNr = Math.floor(Math.random() * 3) + 1;   //choose a random chest; 1, 2 or 3
